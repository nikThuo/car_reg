...
from general.views import participants, assets, transactions, ledger, user_vehicles, user_vehicle_history
...
urlpatterns = [
    ...
    url(r'^users/user_vehicles$', user_vehicles, name='user_vehicles'),
    url(r'^users/user_vehicle_history$', user_vehicle_history, name='users_vehicle_history'),
]
